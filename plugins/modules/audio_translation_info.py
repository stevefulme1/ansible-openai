...
DOCUMENTATION = r"""
---
module: audio_translation_info
short_description: List available OpenAI audio translation models
description:
...
EXAMPLES = r"""
- name: List available OpenAI audio translation models
  stevefulme1.openai.audio_translation_info:
