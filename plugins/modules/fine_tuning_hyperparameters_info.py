...
DOCUMENTATION = r"""
---
module: fine_tuning_hyperparameters_info
short_description: Get hyperparameters of an OpenAI fine-tuning job
description:
...
EXAMPLES = r"""
- name: Get hyperparameters of an OpenAI fine-tuning job
  stevefulme1.openai.fine_tuning_hyperparameters_info:
