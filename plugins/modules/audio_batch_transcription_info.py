...
DOCUMENTATION = r"""
---
module: audio_batch_transcription_info
short_description: Get OpenAI batch transcription job status
description:
...
options:
  batch_id:
    description: ID of the batch transcription job.
    type: str
    required: true
"""

EXAMPLES = r"""
- name: Get OpenAI batch transcription job status
  stevefulme1.openai.audio_batch_transcription_info:
