...
DOCUMENTATION = r"""
---
module: moderation_batch_info
short_description: Get OpenAI batch moderation job status
description:
...
options:
  batch_id:
    description: ID of the batch moderation job.
    type: str
    required: true
"""

EXAMPLES = r"""
- name: Get OpenAI batch moderation job status
  stevefulme1.openai.moderation_batch_info:
