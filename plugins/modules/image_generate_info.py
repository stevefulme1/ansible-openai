...
DOCUMENTATION = r"""
---
module: image_generate_info
short_description: List available OpenAI image generation models
description:
...
EXAMPLES = r"""
- name: List available OpenAI image generation models
  stevefulme1.openai.image_generate_info:
