...
DOCUMENTATION = r"""
---
module: image_variation_info
short_description: List available OpenAI image variation models
description:
...
EXAMPLES = r"""
- name: List available OpenAI image variation models
  stevefulme1.openai.image_variation_info:
