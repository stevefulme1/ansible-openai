...
DOCUMENTATION = r"""
---
module: image_batch_info
short_description: Get OpenAI batch image generation job status
description:
...
options:
  batch_id:
    description: ID of the batch image generation job.
    type: str
    required: true
"""

EXAMPLES = r"""
- name: Get OpenAI batch image generation job status
  stevefulme1.openai.image_batch_info:
