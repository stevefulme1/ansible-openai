...
DOCUMENTATION = r"""
---
module: image_edit_info
short_description: List available OpenAI image editing models
description:
...
EXAMPLES = r"""
- name: List available OpenAI image editing models
  stevefulme1.openai.image_edit_info:
