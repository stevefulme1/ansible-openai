...
DOCUMENTATION = r"""
---
module: chat_completion_with_tools_info
short_description: Get details of a tool-augmented chat completion
description:
...
EXAMPLES = r"""
- name: Get details of a tool-augmented chat completion
  stevefulme1.openai.chat_completion_with_tools_info:
