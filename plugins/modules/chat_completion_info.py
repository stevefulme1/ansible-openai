...
DOCUMENTATION = r"""
---
module: chat_completion_info
short_description: Get details of an OpenAI chat completion
description:
...
EXAMPLES = r"""
- name: Get details of an OpenAI chat completion
  stevefulme1.openai.chat_completion_info:
