...
DOCUMENTATION = r"""
---
module: chat_completion_vision_info
short_description: Get details of a vision chat completion
description:
...
EXAMPLES = r"""
- name: Get details of a vision chat completion
  stevefulme1.openai.chat_completion_vision_info:
