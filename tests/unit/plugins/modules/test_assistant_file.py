"""Unit tests for stevefulme1.openai.assistant_file module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.openai.plugins.modules.assistant_file"
CLIENT_PATH = "ansible_collections.stevefulme1.openai.plugins.module_utils.openai_client"


def _build_resource(**overrides):
    """Return a mock assistant_file resource dict."""
    base = {
        "id": "res-123",
        "object": "assistant_file",
    }
...
@pytest.fixture
def module_args():
    """Base module args for assistant_file."""
    return {
        "state": "present",
        "api_key": "sk-test-key",
        "organization": None,
...
class TestCreate:
    ...
    def test_create_resource(self, mock_ansible_cls, mock_client_cls, module_args):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.assistant_file import main
        try:
            main()
        except SystemExit:
            pass
...
class TestDelete:
    ...
    def test_delete_resource(self, mock_ansible_cls, mock_client_cls, module_args):
        ...
        module_args["assistant_id"] = "res-123"
        mock_module = MagicMock()
        mock_module.exit_json = MagicMock(side_effect=SystemExit(0))
        mock_module.fail_json = MagicMock(side_effect=SystemExit(1))
        mock_module.params = module_args
...
class TestUpdate:
    """Test assistant_file update with existing ID."""
