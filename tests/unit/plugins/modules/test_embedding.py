...
def _build_resource(**overrides):
    """Return a mock embedding resource dict."""
    base = {
        "id": "res-123",
        "input": "test-input",
        "model": "test-model",
        "dimensions": "test-dimensions",
        "encoding_format": "test-encoding_format"
    }
...
def resource_args(module_args):
    """Module args for embedding operations."""
    module_args.update({
        "state": "present",
...
class TestGetCurrentState:
    ...
    def test_returns_none_without_lookup(self, resource_args):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.embedding import get_current_state
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.embedding import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.embedding import build_payload
...
class TestCreate:
    ...
    def test_create_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        with patch(f"{MODULE_PATH}.get_current_state", return_value=None):
            from ansible_collections.stevefulme1.openai.plugins.modules.embedding import main
            main()
