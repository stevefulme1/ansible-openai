"""Unit tests for stevefulme1.openai.content_filter_policy module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.openai.plugins.modules.content_filter_policy"
CLIENT_PATH = "ansible_collections.stevefulme1.openai.plugins.module_utils.openai_client"


def _build_resource(**overrides):
    """Return a mock content_filter_policy resource dict."""
    base = {
        "id": "res-123",
        "object": "content_filter_policy",
    }
...
@pytest.fixture
def module_args():
    """Base module args for content_filter_policy."""
    return {
        "state": "present",
        "api_key": "sk-test-key",
        "organization": None,
...
class TestCreate:
    """Test content_filter_policy creation."""
    ...
    def test_create_resource(self, mock_ansible_cls, mock_client_cls, module_args):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.content_filter_policy import main
        try:
            main()
        except SystemExit:
            pass
...
class TestDelete:
    """Test content_filter_policy deletion."""
...
class TestUpdate:
    """Test content_filter_policy update with existing ID."""
