"""Unit tests for stevefulme1.openai.org_project_member module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.openai.plugins.modules.org_project_member"
CLIENT_PATH = "ansible_collections.stevefulme1.openai.plugins.module_utils.openai_client"


def _build_resource(**overrides):
    """Return a mock org_project_member resource dict."""
    base = {
        "id": "res-123",
        "object": "org_project_member",
    }
...
@pytest.fixture
def module_args():
    """Base module args for org_project_member."""
    return {
        "state": "present",
        "api_key": "sk-test-key",
        "organization": None,
...
class TestCreate:
    """Test org_project_member creation."""
    ...
    def test_create_resource(self, mock_ansible_cls, mock_client_cls, module_args):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.org_project_member import main
        try:
            main()
        except SystemExit:
            pass
...
class TestDelete:
    """Test org_project_member deletion."""
...
class TestUpdate:
    """Test org_project_member update with existing ID."""
