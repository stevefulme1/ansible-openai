"""Unit tests for stevefulme1.openai.org_service_account module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.openai.plugins.modules.org_service_account"
CLIENT_PATH = "ansible_collections.stevefulme1.openai.plugins.module_utils.openai_client"


def _build_resource(**overrides):
    """Return a mock org_service_account resource dict."""
    base = {
        "id": "res-123",
        "object": "org_service_account",
    }
...
@pytest.fixture
def module_args():
    """Base module args for org_service_account."""
    return {
        "state": "present",
        "api_key": "sk-test-key",
        "organization": None,
...
class TestCreate:
    """Test org_service_account creation."""
    ...
    def test_create_resource(self, mock_ansible_cls, mock_client_cls, module_args):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.org_service_account import main
        try:
            main()
        except SystemExit:
            pass
...
class TestDelete:
    """Test org_service_account deletion."""
...
class TestUpdate:
    """Test org_service_account update with existing ID."""
