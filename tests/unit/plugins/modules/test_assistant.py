...
def _build_resource(**overrides):
    """Return a mock assistant resource dict."""
    base = {
        "id": "res-123",
        "name": "test-name",
...
def resource_args(module_args):
    """Module args for assistant operations."""
    module_args.update({
        "state": "present",
...
class TestGetCurrentState:
    ...
    def test_returns_matching_resource(self, resource_args):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.assistant import get_current_state
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.assistant import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.openai.plugins.modules.assistant import build_payload
...
class TestCreate:
    ...
    def test_create_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        with patch(f"{MODULE_PATH}.get_current_state", return_value=None):
            from ansible_collections.stevefulme1.openai.plugins.modules.assistant import main
            main()
